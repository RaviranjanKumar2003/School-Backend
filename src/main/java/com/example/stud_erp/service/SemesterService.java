...
public class SemesterService {
    ...
    public void createSubjects(List<SubjectSessionDTO> subjectDTOs, Semester semester) {
        for (SubjectSessionDTO subjectDTO : subjectDTOs) {
            SubjectSession subject = new SubjectSession();
